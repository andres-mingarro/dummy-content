...
// gradient — preserveAspectRatio xMidYMid slice over viewBox 0 0 1600 800
// primary-color: base (darkest); secondary-color: highlight (lightest)
// intermediate wave layers are hardcoded gradient steps between the two
